...
public class Enemy2Pathfinding : MonoBehaviour
{
    ...
    public void Update()
    {
        if (Test.isIATurn && Test.IATurn == 2)
        {
            ...
            if (closestIA != null) //Hay IA en rango        
            {
                ...
                if (closestPlayerToAttack != null) //Hay Player en rango de closestIA
                {
                    ...
                    if (EnemyHealth.currentHealth >= 50) //IA vida >= 50
                    {
                        ...
                        {
                            if (totalBullets > 0 && PlayerHealth.currentHealth > 20) //Tiene balas && vida del closestPlayer > 20
                            {
                                //Salta y ataca
                        ...
                        else //No hay muros cerca del closestPlayer de la closestIA o no tiene munición
                        {
                            ...
                            {
                                Debug.Log("Hay munición en rango de closestIA");
