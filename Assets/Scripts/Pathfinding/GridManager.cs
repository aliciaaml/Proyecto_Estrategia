...
public class GridManager<TGridObject> 
{
    ...
    private TGridObject[,] gridArray;   //Array multidimensional (2 dimensiones)

    public GridManager(int width, int height, float cellSize, Vector3 originPosition, Func<GridManager<TGridObject>, int, int, TGridObject> createGridObject) {
    ...
    //Convierte x e y de una celda en posiciones del escenario   
    public Vector3 GetWorldPosition(int x, int y){

        return new Vector3(x,y) * cellSize + originPosition;
    }

    //Convierte posiciones del escenario en x e y de una celda
    ...
    //Asigna un valor a dada una posición de celda
